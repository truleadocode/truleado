...
// ---------------------------------------------------------------------------
// Legacy reads (deprecated but still present for UI transition)
// ---------------------------------------------------------------------------
...
export async function discoveryUnlocks(
  ...
  if (error) throw new Error('Failed to fetch discovery unlocks');
...
export async function discoveryExports(
  ...
  const { data, error } = await query;
  if (error) throw new Error('Failed to fetch discovery exports');
