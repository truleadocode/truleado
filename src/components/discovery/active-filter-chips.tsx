...
const FILTER_LABELS: Record<string, string> = {
  ...
  geo: "Location",
  lang: "Language",
  audience_geo: "Aud. Location",
  audience_lang: "Aud. Language",
  audience_gender: "Aud. Gender",
  audience_age: "Aud. Age",
  audience_race: "Aud. Ethnicity",
  audience_credibility: "Credibility",
  relevance: "Topics",
  audience_relevance: "Aud. Topics",
  semantic: "AI Search",
  text_tags: "Hashtags",
  account_category: "Category",
  notable_users_ratio: "Notable Ratio",
  brand: "Brands",
  brand_category: "Brand Category",
  audience_brand: "Aud. Brands",
  audience_brand_category: "Aud. Brand Cat.",
  has_ads: "Sponsored",
  total_views_growth: "Views Growth",
  total_likes_growth: "Likes Growth",
}
